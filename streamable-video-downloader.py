...
class GUI:
    def __init__(self, master):
        ...
        self.text_instruction1 = ttk.Label(self.master,
                                           text="Log in to streamable, open API page and copy paste the content to text field below")
        ...
        self.link1.pack()
        self.link1.bind("<Button-1>", lambda e: callback(
            "https://ajax.streamable.com/videos?sort=date_added&sortd=ASC&count=10000&page=1"))
        ...
        self.check_download_only_pending = ttk.Checkbutton(self.master,
                                                           text='Download only marked as pending to delete', onvalue=1,
                                                           offvalue=0, variable=self.is_pending_checked)
        ...
        self.button_start_download = ttk.Button(self.master, text="Start download",
                                                command=download_manager.start_thread)
...
class VidList:
    ...
    def get_list(self):
        ...
        gui.entry_total_pending_delete_duration.insert(0, str(datetime.timedelta(
            seconds=round(self.pending_delete_total_duration))))
...
class DownloadManager:
    ...
    def start(self):
        ...
        while (self.is_runnning == True):
            ...
            gui.text_current_speed['text'] = sizeof_fmt(self.current_speed) + "/s (" + str(
